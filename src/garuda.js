...
setContent(n) 
{
var ct = (n === undefined) ? '' : n; if (this.__ty__ == true || this.__ty__==null) {if (this.index === undefined) {for (var i = 0; i < this._gLe(); i++) { this.getObj[i].innerHTML = ct; } } else {return (this.index > this._gLe()) ? null : this.getObj[this.index].innerHTML = ct; } } else if (this.__ty__ == false) {this.getById().innerHTML = ct; }
}
clearContent(i) 
{
...
getById() 
{
if (this.o === undefined) { return undefined; } if (this.o.substring(0, 1) === _config_.class) {var x = (this.o.substring(1, this.o.length)); this.__ty__ = true; return (x != undefined) ? __gEc(x) : undefined; } else if (this.o.substring(0, 1) === _config_.tag) {var x = (this.o.substring(1, this.o.length)); this.__ty__ = null; var l = x.length; if (this.index===undefined) {return __gEt(x); }else{return this.index <= l ? __gEt(x)[this.index] : undefined; } } else {if (__gEi(this.o)) {this.__ty__ = false; return __gEi(this.o); } else { this.__ty__ = undefined; return undefined; } }
}
_gLe()
{

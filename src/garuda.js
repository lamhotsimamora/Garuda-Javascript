...
function __cE_(o)
{
return (o) ? document.createElement(o) : undefined;
}

function __cN_(t)
{
return (t) ? document.createTextNode(t) : undefined;
}

function __gEt(o)
{
return (o) ? document.getElementsByTagName(o) : undefined;
}
...
{  
when(d,cb) {if (d) {if (this.getObj) {((cb!=undefined) && _isFunction(cb)) ? this.getObj.addEventListener(d, cb) : false; } } } get __HV__() {var res = {html:this.getContent, value:this.getValue }; return JSON.stringify(res); } 
}

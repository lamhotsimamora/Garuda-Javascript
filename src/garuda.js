...
key(fc,kx) 
{
var kc = (this.kC===undefined) ? kx : this.kC; if (_isFunction(fc)) {if (this.getObj==null) {return null; } this.getObj.addEventListener('keydown', function(e) {if (e.keyCode==kc) {fc(); } }, true); }
}
getSelected()
{
